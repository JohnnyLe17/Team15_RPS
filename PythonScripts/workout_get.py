...
def getGroups():
    groups = {"Abdominals", "Abductors", "Adductors", "Biceps", "Calves", "Chest", "Forearms", "Glutes", "Hamstrings", "Lats", "Lower Back", "Middle Back", "Neck", "Quadriceps", "Traps", "Triceps"}
    for group in groups:
        print ("<span class='dot'>" + group + "</span>")
